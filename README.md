...
Welcome to my personal learning repository! I created this space to build a consistent daily habit of learning, tracking my progress, and documenting my growth. 
...
| :--- | :--- | :--- | :--- |
| [BroCode/C++FullCourseforfree](file:///d:/save/coding/learning/BroCode/C++FullCourseforfree) | **C++ Full Course for Beginners** (Bro Code) | `C++`, `g++ (MinGW)` | 21 / 60 Topics Covered (35.0%) |
...
- **Core Concepts Covered:** Variables & basic data types, const keyword, namespaces, typedefs & type aliases, arithmetic operators, type conversion, user input, useful math functions, Hypotenuse Calculator program, if statements, switches, Console Calculator program, ternary operator, logical operators, temperature conversion program, useful string methods, while loops, do while loops, for loops, break & continue, nested loops.
...
### 4. 🐹 Go Programming
- **Location:** [freeCodeCamp.org/GoProgramming](file:///d:/save/coding/learning/freeCodeCamp.org/GoProgramming)
...
- **Reference:** [JavaScript README](file:///d:/save/coding/learning/ProgrammingWithMosh/JavaScriptCourseForBeginners/README.md)
...
- **AI Engineering & Automation:** Building autonomous AI agents and utilizing agentic IDEs to optimize complex workflows.
- **Algorithmic Trading Systems:** Developing and refining quantitative strategies and crypto trading bots.
- **Language Learning:** Consistent Japanese language practice, heavily focused on listening and speaking skills through shadowing.

## 📈 Long-Term Goals

- Push code, notes, or project updates to this repository as consistently as possible.
- Transition learning materials into fully functional, professional-grade portfolio projects.
- Create a searchable personal knowledge base of "Aha!" moments and technical reference guides.