...
const require_versionSelector = require('./versionSelector-Hu6KMz7r.js');
...
const clerkUIScriptUrl = (opts) => {
	...
	const version = require_versionSelector.versionSelector(__internal_clerkUIVersion, "1.12.1");
